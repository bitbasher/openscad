/*
 Old/Example017
 Using customerizer to select the presentation of the model.
 */

// Customizer variables
// Model drawn in "parts", "exploded" for viewing, or "assembled".
